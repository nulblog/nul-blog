...
import com.gudao.system.mapper.PostMapper;
import com.gudao.system.mapper.UserPostMapper;
import com.gudao.system.service.IPostService;
...
public class PostServiceImpl implements IPostService {
    ...
    public boolean checkPostNameUnique(Post post) {
        Long postId = StringChangeUtils.isNull(post.getPostId()) ? -1L : post.getPostId();
        Post info = postMapper.checkPostNameUnique(post.getPostName());
        if (StringChangeUtils.isNotNull(info) && info.getPostId().longValue() != postId.longValue()) {
